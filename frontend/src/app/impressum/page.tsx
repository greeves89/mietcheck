        ...
        <div className="space-y-8 text-foreground">
          <section>
            ...
            <div className="bg-card border border-border rounded-xl p-6 text-muted-foreground space-y-1">
              <p className="font-semibold text-foreground">MietCheck</p>
              <p>Musterstraße 1</p>
          ...
          <section>
            ...
            <div className="bg-card border border-border rounded-xl p-6 text-muted-foreground space-y-1">
              <p>E-Mail: <a href="mailto:info@mietcheck.de" className="text-primary hover:underline">info@mietcheck.de</a></p>
            </div>
          </section>
