        ...
        <div className="space-y-8 text-foreground">
          <section className="bg-card border border-border rounded-xl p-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Verantwortlicher im Sinne der DSGVO ist: MietCheck, Musterstraße 1, 12345 Musterstadt, E-Mail: info@mietcheck.de
            </p>
          </section>
          ...
          <section className="bg-card border border-border rounded-xl p-6">
            ...
            <ul className="text-muted-foreground space-y-1 list-disc list-inside">
              ...
              <li>Mietvertragsdaten (Wohngröße, Mietzins, Nebenkosten)</li>
              <li>Nebenkostenabrechnungen (von Ihnen hochgeladene Daten)</li>
          ...
          <section className="bg-card border border-border rounded-xl p-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Ihre Daten werden ausschließlich zur Bereitstellung der MietCheck-Dienste verarbeitet: Prüfung von Nebenkostenabrechnungen, Erstellung von Widerspruchsbriefen und Zahlungsabwicklung. Eine Weitergabe an Dritte erfolgt nicht, außer soweit gesetzlich erforderlich.
            </p>
          </section>
          ...
          <section className="bg-card border border-border rounded-xl p-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Bei Fragen zum Datenschutz: <a href="mailto:datenschutz@mietcheck.de" className="text-primary hover:underline">datenschutz@mietcheck.de</a>
            </p>
          </section>
